        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-7 space-y-6 md:space-y-8">
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 pt-1 border-b border-neutral-200 pb-4">
                <div className="px-4 py-2.5 rounded-xl font-mono text-[10px] uppercase tracking-wider font-extrabold bg-neutral-100 text-[#003e1c] border border-neutral-200 shadow-sm flex items-center gap-2">
                  <CreditCard className="w-3.5 h-3.5 text-[#003e1c]" />
                  ...
                  >
                    ...
                    <div className="flex justify-between items-start mb-4">
                      <div className="space-y-0.5">
                        <span className="text-[8px] uppercase tracking-widest opacity-75 font-mono text-stone-300">ROTBA COUTURE</span>
              ...
              {resolvedItems.map((item) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0 flex flex-col justify-center space-y-1">
                    ...
                    <p className="text-[9px] text-[#003e1c] font-mono font-extrabold uppercase tracking-widest">{item.product!.fabric} • Qty: {item.quantity}</p>
                  </div>
