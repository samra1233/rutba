...
function MainLayout() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-between select-none bg-[#f9f9f9] text-neutral-900">
      ...
      {/* 5. BRAND FOOTER */}
      {activePage === 'home' && (
        <footer className="hidden md:block relative w-full rounded-t-[3.5rem] md:rounded-t-[4.5rem] overflow-hidden border-t border-neutral-200 shadow-[0_-10px_30px_rgba(0,0,0,0.03)] z-20 bg-white">
        <div
          className="pt-12 pb-8 px-6 md:px-10 text-neutral-900 relative overflow-hidden bg-white"
        >
          {/* Top gold shimmer divider line */}
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#003e1c]/40 to-transparent z-10" />
          ...
          <div className="relative z-10 flex justify-center mb-8">
            <img
              ...
              className="h-28 md:h-36 object-contain select-none pointer-events-none transition-transform duration-300 hover:scale-105 drop-shadow-[0_4px_15px_rgba(0,62,28,0.15)]"
            />
          </div>
          ...
          <div className="relative z-10 max-w-2xl mx-auto grid grid-cols-1 sm:grid-cols-2 gap-12 text-center sm:text-left justify-items-center">
            ...
            <div className="space-y-4 w-full max-w-[240px] text-center sm:text-left">
              <h3
                className="font-serif text-[20px] font-bold text-neutral-900 uppercase tracking-[0.25em] border-b border-neutral-200 pb-2"
                ...
                {[
                  ...
                  <li key={idx}>
                    <button
                      ...
                      className="w-full text-center sm:text-left py-0.5 text-neutral-600 hover:text-[#003e1c] transition-colors duration-300 uppercase text-[12px] tracking-[0.12em] cursor-pointer font-bold font-mono"
                    >
                      {link.label}
                    </button>
                  </li>
          ...
          <div className="relative z-10 flex justify-center items-center gap-6 pt-10 border-t border-neutral-200 mt-10 max-w-2xl mx-auto">
            <a
              href="https://facebook.com"
              target="_blank"
              rel="noopener noreferrer"
              className="w-9 h-9 rounded-full border border-neutral-200 bg-neutral-50 flex items-center justify-center text-neutral-700 hover:text-white hover:bg-[#003e1c] hover:border-[#003e1c] transition-all duration-300 hover:scale-110 shadow-sm"
              aria-label="Facebook"
            >
          ...
          <div className="relative z-10 pt-8 border-t border-neutral-200 mt-10 w-full max-w-7xl mx-auto flex flex-row flex-wrap justify-between items-center gap-4">
            {/* Copyright notice & Staff Admin Portal Link */}
            <div className="text-left text-[11px] font-mono tracking-widest uppercase text-neutral-500 flex items-center gap-4 flex-wrap">
              <span>&copy; {new Date().getFullYear()} RUTBA LUXURY UNSTITCHED. ALL RIGHTS RESERVED.</span>
              <button
                onClick={() => setActivePage('admin')}
                className="text-[#003e1c] hover:text-[#002f15] font-extrabold cursor-pointer hover:underline transition-colors uppercase tracking-widest text-[9.5px]"
              >
                ✦ Staff Admin Portal
              </button>
            </div>
