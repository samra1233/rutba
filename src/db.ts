...
const SEED_PRODUCTS: Product[] = [
  {
    id: "ms-ug01",
    name: "Luxury Cotton Seamless Brassiere",
    price: 180,
    fabric: "Organic Cotton",
    type: "Seamless",
    collection: "Essential Comfort",
    images: [
      "/cat_undergarments.png"
    ],
    description: "A seamless luxury everyday brassiere crafted with ultra-soft organic cotton. Designed for maximum comfort, breathability, and natural silhouette support.",
    stock: 25,
    colors: ["Ivory White", "Nude"],
    viewers: 12,
    isNewArrival: true,
    features: [
      "95% Organic Cotton, 5% Elastane",
      "Seamless design for zero irritation",
      "Soft double-layer cups",
      "Adjustable straps"
    ],
  ...
  {
    id: "ms-ug02",
    name: "Premium Cotton Hipster Briefs (3-Pack)",
    price: 120,
    fabric: "Organic Cotton",
    type: "Hipster",
    collection: "Essential Comfort",
    ...
    description: "A pack of three premium hipster briefs crafted from fine-ribbed organic cotton. Features a flat elastic waistband and tagless design for ultimate everyday comfort.",
    stock: 40,
    colors: ["Ivory White", "Nude", "Blush Rose"],
    viewers: 8,
    isNewArrival: true,
    features: [
      "Pack of 3 premium briefs",
      "100% breathable organic cotton lining",
