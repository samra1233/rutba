    ...
    <div className="space-y-7 text-left relative text-neutral-900">
      <div className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <CategoryRow active={activeFilters.category === 'Ready to Wear' && !activeFilters.pieces} onClick={() => selectTopCategory('category', 'Ready to Wear')}>
            Ready To Wear
          </CategoryRow>
          <CategoryRow active={activeFilters.category === 'Unstitched' && !activeFilters.pieces} onClick={() => selectTopCategory('category', 'Unstitched')}>
            Unstitched
          </CategoryRow>
